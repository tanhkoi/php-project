...
if (isset($_POST['submit'])) {
  ...
  $structure = "
    ...
    (24, 'United States Dollar', 'USD', '$', 'left', '0', '1'),
    (25, 'Vietnam Dong', 'VND', '₫', 'right', '1', '1');
    ...
    (1, 'en_us', 'English', 'flags/en_us.png', 'LTR', '0', '1', 1),
    ...
    (13, 'vi_vn', 'Tiếng Việt', 'flags/vi_vn.png', 'LTR', '1', '1', 13);
    ...
    (2455, 'sngine_appid', ''),
    (2456, 'sngine_secret', ''),
    (2499, 'sngine_app_domain', 'tcsn.tcteamcorp.com'),
    (2522, 'sngine_app_name', 'TCSN'),
    (2570, 'sngine_app_icon', 'tcsn.png'),
...
<head>
  ...
  <title>Trình cài đặt <?php echo SYS_NAME ?> &rsaquo;(v<?php echo SYS_VER ?>)</title>
      ...
      <form id="wizard" method="post" class="position-relative">
        ...
        <section>
          <div class="content-wrapper">
            ...
            <p>
                Chào mừng bạn đến trình cài đặt <strong><?php echo SYS_NAME ?> (v<?php echo SYS_VER ?>)</strong>. Điền đầy đủ thông tin bên dưới để hoàn tất cài đặt.
				<a href="https://www.facebook.com/tcsocialnetwork.tcteamcorp" target="_blank">Hỗ trợ</a>
            </p>
            <h6 class="mt-4">
            ...
            <div>
              ...
              <ol>
                <li>Cài đặt trên một sản phẩm tên miền (domain.com, sub.domain.com hoặc domain.com/thư mục).</li>
            ...
            <div class="form-check mt-5">
              ...
              <label class="form-check-label" for="license-checkbox">Tôi đồng ý với điều khoản và điều kiện được đưa ra.</label>
        ...
        <section>
          <div class="content-wrapper">
            ...
            <div id="requirements_alert" class="alert alert-danger" style="display: none;">
              <strong>Xin lỗi!</strong> Bạn cần kiểm tra các yêu cầu hệ thống để tiếp tục, hãy quay lại trang hỗ trợ hosting để được giúp đỡ.
            </div>
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  <td>PHP 7.4+</td>
                  <td>Yêu cầu PHP phiên bản 7.4 trở lên</td>
                  <td>
                    <?php if ($requirements_errors['PHP']) { ?>
                      <font color="red"><i class="fas fa-times-circle"></i> Chưa được cài đặt</font>
                    <?php } else { ?>
                      <font color="green"><i class="fas fa-check-circle"></i> Đã được cài đặt</font>
                    <?php } ?>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>config.php</td>
                  <td>Yêu cầu thư mục <strong>includes</strong> có thể ghi để cài đặt</td>
                  <td>
          ...
          <div class="content-wrapper">
            ...
            <div class="row mb-4">
              <div class="form-group col-12">
                <label for="purchase_code">Mã Mua Hàng Của Bạn | <a href="https://tcgshop.tcteamcorp.com/purchase_history" target="_blank">Mã mua hàng trên TC Gaming Shop</a></label>
                <input type="text" name="purchase_code" id="purchase_code" class="form-control" value="TCSN_xxxx" placeholder="TCSN_xxxx">
            ...
            <div class="row mb-4">
              <div class="form-group col-12">
                ...
                <input type="text" name="db_name" id="db_name" class="form-control" placeholder="database_name">
                <div class="invalid-feedback">
                  Thông tin không được trống
                </div>
              </div>
            ...
            <div class="row mb-4">
              <div class="form-group col-md-6">
                ...
                <input type="text" name="db_username" id="db_username" class="form-control" placeholder="database_username">
                <div class="invalid-feedback">
                  Thông tin không được trống
                </div>
              </div>
              <div class="form-group col-md-6">
                <label for="db_password">Mật Khẩu Database</label>
                <input type="text" name="db_password" id="db_password" class="form-control" placeholder="database_password">
              </div>
            </div>
            <div class="row mb-4">
              <div class="form-group col-md-6">
        ...
        <section>
          <div class="content-wrapper">
            ...
            <p class="mb-4">
              <strong>Mã mua hàng (<a target="_blank" href="https://tcgshop.tcteamcorp.com/purchase_history">TC Gaming Shop</a>):</strong> <span id="entered_purchase_code"></span>
            </p>
            <h6 class="font-weight-bold">Thông Tin Database</h6>
            <p class="mb-4">
              <strong>Tên Database:</strong> <span id="entered_db_name"></span> <br>
              <strong>Username Database:</strong> <span id="entered_db_username"></span> <br>
              <strong>Mật Khẩu Database:</strong> <span id="entered_db_password"></span> <br>
