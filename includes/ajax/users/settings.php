...
try {
  ...
  switch ($_GET['edit']) {
    ...
    case 'basic':
      // valid inputs
      if (!isset($_POST['firstname']) || !isset($_POST['lastname']) || (!$system['genders_disabled'] && !isset($_POST['gender'])) || !isset($_POST['birth_month']) || !isset($_POST['birth_day']) || !isset($_POST['birth_year'])) {
        _error(400);
      }
