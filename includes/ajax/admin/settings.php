...
try {
  ...
  switch ($_GET['edit']) {
    ...
    case 'modules':
      ...
      $_POST['reviews_enabled'] = (isset($_POST['reviews_enabled'])) ? '1' : '0';
      $_POST['reviews_replacement_enabled'] = (isset($_POST['reviews_replacement_enabled'])) ? '1' : '0';
      ...
      update_system_options([
        ...
        'reviews_enabled' => secure($_POST['reviews_enabled']),
        'reviews_replacement_enabled' => secure($_POST['reviews_replacement_enabled']),
