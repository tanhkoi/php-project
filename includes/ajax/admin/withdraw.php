    ...
    case 'market':
      ...
      switch ($_POST['handle']) {
        case 'approve':
          ...
          /* send notification to request author */
          $user->post_notification(array('to_user_id' => $withdrawal_request['user_id'], 'action' => 'market_withdrawal_approved'));
          break;
        ...
        case 'decline':
          ...
          /* send notification to request author */
          $user->post_notification(array('to_user_id' => $withdrawal_request['user_id'], 'action' => 'market_withdrawal_declined'));
          break;
